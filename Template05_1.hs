...
--修改了部分，用函数的方式实现true,false,if,pair,consdeng

module Template05_1 where
...
extraPreludeDefs = [ ("False", ["t","f"], A $ EVar "f"),
                     ("True", ["t","f"], A $ EVar "t"),
                     ("if", [], A $ EVar "I"),
                     ("and",["b1","b2","t","f"], EAp
                                                 (EAp
                                                  (A $ EVar "b1")
                                                   (EAp
                                                     (EAp (A $ EVar "b2") (A $ EVar "t"))
                                                     (A $ EVar "f")))
                                                 (A $ EVar "f")),
                     ("or", ["b1","b2","t","f"], EAp
                                                 (EAp (A $ EVar "b1") (A $ EVar "t"))
                                                 (EAp
                                                  (EAp (A $ EVar "b2") (A $ EVar "t"))
                                                  (A $ EVar "f"))),
                     ("casePair", [], A $ EVar "I"),
                     ("mkPair", ["a","b","f"], EAp
                                               (EAp (A $ EVar "f") (A $ EVar "a"))
                                               (A $ EVar "b")),

                     ("fst", ["p"], EAp (A $ EVar "p") (A $ EVar "K")),
                     ("snd", ["p"], EAp (A $ EVar "p") (A $ EVar "K1")),
                     ("caseList", [], A $ EVar "I"),
                     ("nil", ["cn","cc"], A $ EVar "cn"),
                     ("cons", ["a","b","cn","cc"], EAp
                                                   (EAp (A $ EVar "cc") (A $ EVar "a"))
                                                   (A $ EVar "b")),
                     ("head", ["xs"], EAp
                                      (EAp
